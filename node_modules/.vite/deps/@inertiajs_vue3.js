import {
  axios_default
} from "./chunk-PMYQA6Q2.js";
import {
  require_cjs,
  require_lib
} from "./chunk-RPHPNHNB.js";
import {
  computed,
  createSSRApp,
  defineComponent,
...
var j = (t) => m("before", { cancelable: true, detail: { visit: t } });
...
function A(t, e = new FormData(), i = null) {
  t = t || {};
  for (let n in t)
    Object.prototype.hasOwnProperty.call(t, n) && _(e, J(i, n), t[n]);
  return e;
}
function J(t, e) {
  return t ? t + "[" + e + "]" : e;
...
function _(t, e, i) {
  if (Array.isArray(i))
    return Array.from(i.keys()).forEach((n) => _(t, J(e, n.toString()), i[n]));
...
function k(t, e, i, n = "brackets") {
  ...
  return t === "get" && Object.keys(i).length && (c2.search = O.stringify((0, import_deepmerge2.default)(O.parse(c2.search, { ignoreQueryPrefix: true }), i), { encodeValuesOnly: true, arrayFormat: n }), i = {}), [[s ? `${c2.protocol}//${c2.host}` : "", l ? c2.pathname : "", h2 ? c2.pathname.substring(1) : "", g2 ? c2.search : "", f ? c2.hash : ""].join(""), i];
}
function w(t) {
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: s = false, preserveScroll: l = false, preserveState: h2 = false, only: g2 = [], except: f = [], headers: c2 = {}, errorBag: o = "", forceFormData: v = false, onCancelToken: T2 = () => {
    ...
    let M2 = !!(g2.length || f.length);
    axios_default({ method: i, url: w(S).href, data: i === "get" ? {} : n, params: i === "get" ? n : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...c2, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...M2 ? { "X-Inertia-Partial-Component": this.page.component } : {}, ...g2.length ? { "X-Inertia-Partial-Data": g2.join(",") } : {}, ...f.length ? { "X-Inertia-Partial-Except": f.join(",") } : {}, ...o && o.length ? { "X-Inertia-Error-Bag": o } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (r) => {
      ...
      let a = r.data;
      M2 && a.component === this.page.component && (a.props = (0, import_deepmerge.default)(this.page.props, a.props, { arrayMerge: (he, ne) => ne })), l = this.resolvePreserveOption(l, a), h2 = this.resolvePreserveOption(h2, a), h2 && ((_a = window.history.state) == null ? void 0 : _a.rememberedState) && a.component === this.page.component && (a.rememberedState = window.history.state.rememberedState);
      let E2 = S, V = b(a.url);
      ...
      if (this.isLocationVisitResponse(r.response)) {
        ...
        q(r.response) && z.show(r.response.data);
      else
...
function ee({ delay: t = 250, color: e = "#29d", includeCSS: i = true, showSpinner: n = false } = {}) {
  ae(t), import_nprogress.default.configure({ showSpinner: n }), i && pe(e);
}
function te(t) {
...
var M = { created() {
  ...
  let e = this.$options.remember.key instanceof Function ? this.$options.remember.key.call(this) : this.$options.remember.key, o = De.restore(e), n = this.$options.remember.data.filter((t) => !(this[t] !== null && typeof this[t] == "object" && this[t].__rememberable === false)), p = (t) => this[t] !== null && typeof this[t] == "object" && typeof this[t].__remember == "function" && typeof this[t].__restore == "function";
  n.forEach((t) => {
    this[t] !== void 0 && o !== void 0 && o[t] !== void 0 && (p(t) ? this[t].__restore(o[t]) : this[t] = o[t]), this.$watch(t, () => {
      De.remember(n.reduce((a, l) => ({ ...a, [l]: (0, import_lodash.default)(p(l) ? this[l].__remember() : this[l]) }), {}), e);
    }, { immediate: true, deep: true });
  });
} };
var D = M;
function T(e, o) {
  let n = typeof e == "string" ? e : null, p = typeof e == "string" ? o : e, t = n ? De.restore(n) : null, a = typeof p == "object" ? (0, import_lodash2.default)(p) : (0, import_lodash2.default)(p()), l = null, f = null, h2 = (r) => r, y = reactive({ ...t ? t.data : (0, import_lodash2.default)(a), isDirty: false, errors: t ? t.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    let m2 = h2(this.data()), b2 = { ...i, onCancelToken: (u2) => {
      ...
      if (this.wasSuccessful = false, this.recentlySuccessful = false, clearTimeout(f), i.onBefore)
    ...
    r === "delete" ? De.delete(s, { ...b2, data: m2 }) : De[r](s, m2, b2);
  }, get(r, s) {
    this.submit("get", r, s);
  }, post(r, s) {
  ...
  return watch(y, (r) => {
    y.isDirty = !(0, import_lodash3.default)(y.data(), a), n && De.remember((0, import_lodash2.default)(r.__remember()), n);
...
var W2 = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  return k2 = Y(a, p, t), a || (De.init({ initialPage: e, resolveComponent: n, swapComponent: async (l) => {
    c.value = markRaw(l.component), d.value = l.page, F.value = l.preserveState ? F.value : Date.now();
  } }), De.on("navigate", () => k2.forceUpdate())), () => {
    if (c.value) {
...
var E = W2;
var $2 = { install(e) {
  De.form = T, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => De }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => d.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => k2 }), e.mixin(D);
} };
function Q2() {
...
<Link href="${a}" method="${t}" as="button">...</Link>`), h(e.as, { ...n, ...p === "a" ? { href: a } : {}, onClick: (f) => {
      te(f) && (f.preventDefault(), De.visit(a, { data: l, method: t, replace: e.replace, preserveScroll: e.preserveScroll, preserveState: e.preserveState ?? t !== "get", only: e.only, except: e.except, headers: e.headers, onCancelToken: n.onCancelToken || (() => ({})), onBefore: n.onBefore || (() => ({})), onStart: n.onStart || (() => ({})), onProgress: n.onProgress || (() => ({})), onFinish: n.onFinish || (() => ({})), onCancel: n.onCancel || (() => ({})), onSuccess: n.onSuccess || (() => ({})), onError: n.onError || (() => ({})) }));
    } }, o);
  };
} });
var ie = se2;
function O2(e, o) {
  if (typeof e == "object" && e !== null && e.__rememberable === false)
    return e;
  let n = De.restore(o), p = isReactive(e) ? reactive : ref, t = typeof e.__remember == "function" && typeof e.__restore == "function", a = p(n === void 0 ? e : t ? e.__restore(n) : n);
  return watch(a, (l) => {
    De.remember((0, import_lodash4.default)(t ? e.__remember() : l), o);
