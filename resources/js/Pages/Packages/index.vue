        ...
        <div class="w-[90%] mx-auto rounded-lg border border-gray-200 p-5 m-5">
            ...
            <div class="overflow-auto rounded-lg shadow p-4">
                ...
                >
                    <thead class="text-white">
                        <tr
                            v-for="(package_patient, index) in packages.data"
                    ...
                    <tbody class="flex-1 sm:flex-none md:flex-none">
                        ...
                        >
                            ...
                            >
                                {{ changeFormat(package_patient.date) }}
                            </td>
                            <td
                                class="text-xs text-center wrap border-grey-light border p-3 h-14 md:text-xs lg:text-md overflow-auto"
                            >
                            ...
                            >
                                ...
                                {{ package_patient.service.quantity }}
                            </td>
                            ...
                            >
                                {{
                                    package_patient.status_payment == "PARTIAL"
                                        ? "PARCIAL"
                                        : package_patient.status_payment ==
                                          "PAID"
                                        ? "PAGADO"
                                        : "PENDIENTE"
                                }}
            ...
            >
                <div class="flex items-center mb-4 sm:mb-0">
                    ...
                    <Link
                        v-if="packages.current_page < packages.last_page"
                    ...
                    <span
                        ...
                        <span
                            ...
                            >{{ packages.from }}-{{ packages.to }}</span
                        >
                        De
                        <span
                            class="font-semibold text-gray-900 dark:text-white"
