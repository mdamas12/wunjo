...
import EmployeesForm from "@/Components/Branches/Form.vue";
                    ...
                    <div class="flex items-center mb-4 sm:mb-0">
                        ...
                        <span
                            ...
                            <span
                                ...
                                >{{ employees.from }}-{{ employees.to }}</span
                            >
                            De
                            <span
                                class="font-semibold text-gray-900 dark:text-white"
...
export default {
    ...
    methods: {
        ...
        alert_success() {
            return alert("¡Empleado ha sido eliminado del sistema con exito!");
        },
